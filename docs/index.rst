...
Examples
--------
| `mDNS client <https://components.espressif.com/components/plasmapper/pl_mdns/versions/1.2.5/examples/mdns_client>`_
| `mDNS server <https://components.espressif.com/components/plasmapper/pl_mdns/versions/1.2.5/examples/mdns_server>`_
